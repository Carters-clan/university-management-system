...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    EnterMarks() {
        ...
        lblrollnumber.setFont(new Font("Goudy Old Style", Font.PLAIN, 20));
        add(lblrollnumber);
        ...
        lblsemester.setFont(new Font("Goudy Old Style", Font.PLAIN, 20));
        add(lblsemester);
        ...
        lblentersubject.setFont(new Font("Goudy Old Style", Font.PLAIN, 20));
        add(lblentersubject);
        
         //Enter Marks
        JLabel lblentermarks = new JLabel("Enter Marks");
        lblentermarks.setBounds(320, 150, 200, 40);
        lblentermarks.setFont(new Font("Goudy Old Style", Font.PLAIN, 20));
        add(lblentermarks);
        ...
        cancel.setBounds(290, 370, 150, 30);
