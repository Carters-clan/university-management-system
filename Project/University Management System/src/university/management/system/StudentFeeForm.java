...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        lblname.setFont(new Font("Goudy Old Style", Font.BOLD, 20));
        add(lblname);
        ...
        lblfname.setFont(new Font("Goudy Old Style", Font.BOLD, 20));
        add(lblfname);
        ...
        lblcourse.setFont(new Font("Goudy Old Style", Font.BOLD, 20));
        add(lblcourse);
        
        String course[] = {"BTech", "BSC", "BTech","BCA", "MCA", "MTech", "MSC", "BBA", "MBA", "B.Com", "M.Com", "BA", "MA" };
        ...
        lblbranch.setFont(new Font("Goudy Old Style", Font.BOLD, 20));
        add(lblbranch);
        ...
        lblsemester.setBounds(35, 260, 150, 20);
        lblsemester.setFont(new Font("Goudy Old Style", Font.BOLD, 20));
        add(lblsemester);
        ...
        lbltotal.setFont(new Font("Goudy Old Style", Font.BOLD, 20));
        add(lbltotal);
        
         
        labeltotal = new JLabel();
        labeltotal.setBounds(200, 300, 150, 20);
        labeltotal.setFont(new Font("Goudy Old Style", Font.PLAIN, 20));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Fees Paid Succussfully");
                setVisible(false);
            } catch (Exception e) {
                e.printStackTrace();
            }
